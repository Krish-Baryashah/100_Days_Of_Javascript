...
inputField.addEventListener('input',function(){
    ...
    if (password.length < 8){
        ...
        outputField.style.color = 'red'
            ...
            outputField.style.color = 'red'
            outputField.style.textShadow = " rgb(241 0 3) -2px 0px 16px, rgb(235 63 63) 0px 0px 0px;";
        }else if (password.search(/[A-Z]/) == -1){
            ...
            outputField.style.textShadow = " rgb(241 0 3) -2px 0px 16px, rgb(235 63 63) 0px 0px 0px;";
                ...
                outputField.style.textShadow = " rgb(52 197 24) 0px 0px 8px, rgb(0 4 2) 0px 0px 0px";
            }    
        }
